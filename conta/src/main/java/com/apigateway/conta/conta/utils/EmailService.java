...
public class EmailService {
    ...
    @Async
    public void sendEmail(String to, String subject, String motivo, String userName) throws MessagingException {
        ...
        String messageStr = "<p>Infelizmente sua conta não foi aprovada!</p>";
        ...
        String htmlMsg = "<!DOCTYPE html>" +
                ...
                messageStr +
                "<p>Motivo de reprovação: <strong>" + motivo + "</strong></p>" +
                "</div>" +
                "<div class='footer'>" +
