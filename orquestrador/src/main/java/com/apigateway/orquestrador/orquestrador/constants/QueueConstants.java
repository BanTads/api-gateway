...
public class QueueConstants {
    ...
    public static final String MANAGER_CHECK_EMAIL = "manager.check.email";
    ...
    public static final String[] ALL_QUEUES = {
            ...
            CLIENT_UPDATE, USER_INSERT, CONTA_UPDATE_LIMIT, REMOVE_USER, CLIENT_CHECK_EMAIL, USER_UPDATE, MANAGER_CHECK_EMAIL
    };
}